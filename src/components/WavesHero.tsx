...
import "./WavesHero.css";

const WavesHero: React.FC = () => {
  return (
    <div className="header">
      {/* Content before waves */}
      <div className="inner-header flex">
        {/* <svg version="1.1" className="logo" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 500 500">
          <path fill="#FFFFFF" stroke="#000000" strokeWidth="10" d="M57,283" />
          <g>
            <path
              fill="#fff"
